...
impl SystickDelay {
    ...
    pub fn delay_ticks(&mut self, n: u32) {
        ...
        // TODO: This now accesses the whole 64 bit counter, the overhead is likely larger
        let target = rb.cnt.read().bits().wrapping_add((n - 5) as u64); // at least 5 opcodes overhead
