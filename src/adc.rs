...
pub(crate) mod sealed {
    ...
    pub trait Instance {
        type ADCRegisterBlock;

        // FIXME: This will require a dirty pointer cast
...
impl sealed::Instance for peripherals::ADC1 {
    type ADCRegisterBlock = crate::pac::adc1::RegisterBlock;

    fn regs() -> &'static crate::pac::adc1::RegisterBlock {
        unsafe { &*crate::pac::ADC1::PTR }
    }
...
impl sealed::Instance for peripherals::ADC2 {
    type ADCRegisterBlock = crate::pac::adc2::RegisterBlock;

    fn regs() -> &'static crate::pac::adc1::RegisterBlock {
        unsafe { &*(crate::pac::ADC2::PTR as *const crate::pac::adc1::RegisterBlock) }
    }

    fn enable_and_reset() {
        let rcc = unsafe { &*crate::pac::RCC::ptr() };
        rcc.apb2pcenr.modify(|_, w| w.adc2en().set_bit());
        rcc.apb2prstr.modify(|_, w| w.adc2rst().set_bit());
        rcc.apb2prstr.modify(|_, w| w.adc2rst().clear_bit());
    }
}


impl Instance for peripherals::ADC1 {}
impl Instance for peripherals::ADC2 {}
